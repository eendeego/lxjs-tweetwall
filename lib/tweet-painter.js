...
(function (exports) {
  ...
  var Painter = exports.Painter = function (canvas, options) {
    ...
    if (!options) { options = {}; }
    options.imageManager = options.imageManager || new BrowserImageManager();
    options.htmlUnencode = options.htmlUnencode || noop; // Temporary noop
    self.options = options;

    self.imageManager = options.imageManager;
    self.htmlUnencode = options.htmlUnencode;
